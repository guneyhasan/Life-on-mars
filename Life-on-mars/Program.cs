    ...
    case 3:
        ...
        while (x < (blob / 3))
        {
            for (int i = 0; i <= blob - 3; i = i + 3)
            {
                ...
                {
                    int b = rndmdna.Next(0, 4);
                    int c1 = rndmdna.Next(0, 4);
                    int d = rndmdna.Next(0, 4);
                    randomdna[i] = words[b];
                    randomdna[i + 1] = words[c1];
        ...
        { 
            ...
            if (DNA1[0] != "ATG" || DNA1[1] == "ATG" || DNA1[length] != "TGA" && DNA1[length] != "TAG" && DNA1[length] != "TAA")
            {
        ...
        case 5:
            ...
            if (DNA2[0] == "ATG")
            {
                if (DNA2[1] != "AAA" && DNA2[1] != "TTT" && DNA2[1] != "CCC" && DNA2[1] != "GGG" && DNA2[2] != "AAA" && DNA2[2] != "TTT" && DNA2[2] != "CCC" && DNA2[2] != "GGG")
                {
